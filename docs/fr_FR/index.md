...
* Avec le plugin **agenda**
   ...
   * Il n'est pas nécessaire de déclarer une action de fin, tout activité dans le logement sera considéré comme un retour et relancera le mécanisme de détection
